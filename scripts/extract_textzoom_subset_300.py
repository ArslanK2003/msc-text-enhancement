...
OUTPUT_DIR = Path("datasets/textzoom_subset_300")
...
def extract_split(difficulty: str) -> list[dict]:
    ...
    with env.begin(write=False) as txn:
        ...
        for index in range(1, limit + 1):
            ...
            lr_filename = f"{difficulty}_{index:03d}_lr.png"
            hr_filename = f"{difficulty}_{index:03d}_hr.png"
...
def main():
    ...
    csv_path = OUTPUT_DIR / "textzoom_subset_300_labels.csv"
    ...
    print(f"Total extracted samples: {len(all_rows)}")
