"""Evaluate Real-ESRGAN outputs against the 300 TextZoom HR references."""
...
OUTPUT_CSV = Path("experiments/metrics/psnr_ssim_realesrgan_300_results.csv")
SUMMARY_CSV = Path("experiments/metrics/psnr_ssim_realesrgan_300_summary.csv")
...
def main() -> None:
    ...
    print("Note: 4x Real-ESRGAN outputs were bicubically resized to HR dimensions.")
